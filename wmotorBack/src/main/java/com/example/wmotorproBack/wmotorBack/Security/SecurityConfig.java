        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                ...
                                .requestMatchers("empleado/activaEmpleado/{idEmpleado}").permitAll()
                                ...
                                .requestMatchers("/turno/{id}").permitAll()
                                .requestMatchers("/turno/obtenerPorFecha").permitAll()
                                ...
                                .requestMatchers("/presupuesto/cambiarEstado/{idPresupuesto}").permitAll()
                                .requestMatchers("/presupuesto/obtenerPorCliente/{idCliente}").permitAll()
                                .requestMatchers("/presupuesto/obtenerPorCliente/{idCliente}/estado").permitAll()
                                .requestMatchers("presupuesto/ultimas/cliente/{idCliente}").permitAll()
                                .requestMatchers("/presupuesto/**").permitAll()
                                .requestMatchers("/movimiento/total-ingresos").permitAll()
                                .requestMatchers("/movimiento/ultimosMovimiento").permitAll()
                                .requestMatchers("presupuesto/crear").permitAll()
                                .requestMatchers("/presupuesto/ultimas").permitAll()
